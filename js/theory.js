...
exports.Theory = function() {
    ...
    function Unification(terms) {
        ...
        // Since variables in the two terms might overlap, we prefix them to
        // disambiguate.
        function prefix(termIndex, v) {
            return v;
                /*  TODO: just clone the terms before unifying.
            if (v[0] === "t") return v;
