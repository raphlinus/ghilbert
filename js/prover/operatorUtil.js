...
GH.notationGuide.guideData = [
	...
	{ symbols: ['{...}'], latex: '\\( \\{a \\ldots b\\} \\)', name: 'set of consecutive numbers', link: 'tuple/interval'},
	...
	{ symbols: ['composite'],  name: 'composite number', link: 'number-theory/prime'},
	{ symbols: ['primeset'], latex: 'Primes', name: 'the set of primes', link: 'number-theory/prime'},
	{ symbols: ['compositeset'], latex: 'Composites', name: 'the set of composite numbers', link: 'number-theory/prime'},
	...
	{ symbols: ['sum'], latex: '\\( \\sum \\)', name: 'summation', link: 'arithmetic/sum'},
	{ symbols: ['{.|}'], latex: '\\(\\{S(x)|φ\\} \\)', name: 'apply function to a set'},
	{ symbols: ['product-step'], name: 'product construction step', link: 'arithmetic/product'},
	...
	{ symbols: ['sqrt'], latex: '\\(\\sqrt{x}\\)', name: 'square root', link: 'analysis/sqrt'},
	{ symbols: ['abs'], latex: '\\(|x|\\)', name: 'absolute value', link: 'arithmetic/abs'},
	{ symbols: ['upperbound'], name: 'upper bound', link: 'analysis/upper-bound'},
	{ symbols: ['supremum'], name: 'supremum', link: 'analysis/supremum'},
	{ symbols: ['sup'], name: 'supremum', link: 'analysis/supremum'},
	{ symbols: ['i'], name: 'imaginary number', link: 'analysis/complex-numbers'},
];